...
public class TelaValores extends javax.swing.JFrame {
    ...
    private void btnDividirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDividirActionPerformed
        // TODO add your handling code here:
        int numerador = Integer.parseInt(txtNum.getText()); // Integer.parseInt() = transforma String em Inteiro
        int denominador = Integer.parseInt(txtDen.getText()); // .getText() = Pega o valor dentro
        
        float divisao = numerador / denominador;
        float resultado = (float) Math.sqrt(numerador); // (float) Math.sqrt(numerador) = Typecasting / converte para float
        
        lblDiv.setText(Float.toString(divisao)); // .toString() = Converter um valor do tipo float em uma String
        lblRes.setText(Float.toString(resultado)); // .setText() = Coloca o valor dentro 
