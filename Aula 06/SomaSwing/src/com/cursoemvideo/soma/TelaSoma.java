...
public class TelaSoma extends javax.swing.JFrame {
    ...
    private void btnSomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSomaActionPerformed
        ...
        int n1 = Integer.parseInt(txtN1.getText()); // converte String para Inteiro 
        int n2 = Integer.parseInt(txtN2.getText()); // .getText() = Pegue o texto/Pega valor dentro
        
        int soma = n1 + n2;
        lblSoma.setText(Integer.toString(soma)); // setText() = Mude o texto/Coloca valor dentro
